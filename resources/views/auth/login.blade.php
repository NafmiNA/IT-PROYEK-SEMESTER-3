    ...
    <main class="lg:col-span-6 flex items-center justify-center py-4">
      <div class="w-full max-w-sm">
        <div class="login-card bg-white rounded-2xl shadow-lg p-6">
          ...
          <!-- Tombol Google OAuth -->
          <a href="{{ route('auth.google') }}" class="w-full border border-gray-300 rounded-lg py-2.5 px-4 flex items-center justify-center gap-3 hover:bg-gray-50 transition">
