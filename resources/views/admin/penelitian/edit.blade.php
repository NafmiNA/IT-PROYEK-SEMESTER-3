        ...
        <div class="mx-auto max-w-5xl px-4 py-8">
            ...
            <nav class="mb-6 animate-fade">
                <ol class="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    <li><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></li>
                    <li class="font-semibold text-blue-600">Edit Penelitian</li>
                </ol>
            </nav>
            ...
            <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between mb-8 animate-slide-up">
                <div class="flex items-center gap-3">
                    <a href="{{ route('admin.penelitian.show', $penelitian) }}" 
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Perbarui Penelitian</h1>
                    </div>
                </div>
            </div>

            <form action="{{ route('admin.penelitian.update', $penelitian) }}" method="POST" enctype="multipart/form-data" class="space-y-6 animate-fade">
                @csrf
                @method('PUT')
                    ...
                    <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-blue-100">Detail utama penelitian</p>
                            </div>
                        </div>
                    </div>
                    <div class="p-6 grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div class="md:col-span-2">
                            <label class="block text-sm font-semibold text-gray-900 mb-2">Judul Penelitian <span class="text-red-600">*</span></label>
                            <input type="text" name="judul" value="{{ old('judul', $penelitian->judul) }}" required class="w-full rounded-lg border-2 border-gray-300 bg-white px-4 py-3 text-gray-900 shadow-sm transition-all focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 hover:border-gray-400">
                        ...
                        <div>
                            ...
                            <input type="number" name="tahun" value="{{ old('tahun', $penelitian->tahun) }}" min="2000" max="2100" required class="w-full rounded-lg border-2 border-gray-300 bg-white px-4 py-3 text-gray-900 shadow-sm transition-all focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 hover:border-gray-400">
                        ...
                        <div>
                            ...
                            <input type="number" name="dana" value="{{ old('dana', $penelitian->dana) }}" min="0" class="w-full rounded-lg border-2 border-gray-300 bg-white px-4 py-3 text-gray-900 shadow-sm transition-all focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 hover:border-gray-400">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="url" name="link_jurnal" value="{{ old('link_jurnal', $penelitian->link_jurnal) }}" class="w-full rounded-lg border-2 border-gray-300 bg-white px-4 py-3 text-gray-900 shadow-sm transition-all focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 hover:border-gray-400" placeholder="https://...">
                            @error('link_jurnal') <p class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>
                    </div>
                </section>
                ...
                <section class="rounded-2xl bg-white shadow-lg ring-1 ring-gray-200 overflow-hidden transition-all hover:shadow-xl">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-900 mb-2">Anggota Dosen</label>
                    ...
                    <div class="bg-gradient-to-r from-amber-600 to-amber-700 px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-amber-100">Perbarui file laporan</p>
                            </div>
                        </div>
                    </div>
                    <div class="p-6 space-y-6">
                        <div>
                            <label class="block text-sm font-semibold text-gray-900 mb-2">Unggah Laporan Jurnal (Opsional)</label>
                            <div class="relative">
                                <input type="file" name="laporan_jurnal" accept=".pdf,.doc,.docx" class="block w-full text-sm text-gray-600 file:mr-4 file:py-3 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-amber-600 file:text-white hover:file:bg-amber-700 file:cursor-pointer border-2 border-dashed border-gray-300 rounded-lg px-4 py-8 hover:border-gray-400 transition-colors cursor-pointer bg-gray-50">
                            </div>
                            <p class="mt-2 text-xs text-gray-600">Biarkan kosong jika tidak ingin mengubah file.</p>
                            ...
                            @endif
                            @error('laporan_jurnal') <p class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>
                    </div>
                </section>

                <div class="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-4 animate-slide-up">
                    <a href="{{ route('admin.penelitian.show', $penelitian) }}" class="inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg border-2 border-gray-300 bg-white text-gray-700 text-sm font-semibold shadow-sm hover:bg-gray-50 hover:border-gray-400 transition-all">
                        Batal
                    </a>
