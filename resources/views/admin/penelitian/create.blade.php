<x-app-layout>
    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-gray-50">
        <div class="mx-auto max-w-5xl px-4 py-8">
            ...
            {{-- MODIFIKASI: Rute diubah ke admin.penelitian.store --}}
            <form method="POST" action="{{ route('admin.penelitian.store') }}" enctype="multipart/form-data" class="space-y-6 animate-fade">
                @csrf
