<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto px-6 py-8">
        ...
        {{-- MODIFIKASI: Rute diubah ke admin.pengabdian.update --}}
        <form action="{{ route('admin.pengabdian.update', $pengabdian) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-end gap-3">
                {{-- MODIFIKASI: Rute diubah ke admin.pengabdian.show --}}
                <a href="{{ route('admin.pengabdian.show', $pengabdian) }}" class="inline-flex items-center gap-2 rounded-full border border-gray-200 px-4 py-2 text-sm font-semibold text-gray-600 transition hover:bg-gray-100">
                    Batal
                </a>
