...
<div x-data="{ sidebarOpen: localStorage.getItem('sidebarOpen') === 'true' }" 
    ...
    <aside x-show="sidebarOpen || window.innerWidth >= 1024"
           ...
           class="fixed top-0 left-0 z-50 h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white shadow-2xl transition-all duration-300 lg:translate-x-0"
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-2 space-y-1">
            ...
            <a href="{{ route('dosen.dashboard') }}" 
               class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('dosen.dashboard') ? 'bg-blue-600 text-white shadow-lg' : 'text-gray-300 hover:bg-gray-700/50 hover:text-white' }}"
               x-tooltip="'Dashboard'">
            ...
            <a href="{{ route('dosen.penelitian.index') }}" 
               class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('dosen.penelitian.*') ? 'bg-emerald-600 text-white shadow-lg' : 'text-gray-300 hover:bg-gray-700/50 hover:text-white' }}"
            ...
            <a href="{{ route('dosen.pengabdian.index') }}" 
               class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('dosen.pengabdian.*') ? 'bg-purple-600 text-white shadow-lg' : 'text-gray-300 hover:bg-gray-700/50 hover:text-white' }}"
            ...
            <a href="{{ route('profile.edit') }}" 
               class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('profile.*') ? 'bg-amber-600 text-white shadow-lg' : 'text-gray-300 hover:bg-gray-700/50 hover:text-white' }}"
               x-tooltip="'Profile'">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
