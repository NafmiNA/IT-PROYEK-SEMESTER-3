<x-app-layout>
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 bg-subtle">
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
            ...
            {{-- REFAKTOR: Stat Cards diubah jadi <div>, bukan <button> --}}
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mb-6">
                
                {{-- Total Card (Biru) --}}
                <div class="text-left w-full bg-blue-600 rounded-lg shadow-md card-hover p-5 animate-slide-up" style="animation-delay: 0.05s">
                    ...
                    <p class="text-3xl sm:text-4xl font-bold text-white stat-num mb-1">{{ $roleCounts['total'] }}</p>
                    <p class="text-sm text-blue-100 font-medium">Total User</p>
                </div>
            
                {{-- Admin Card (Rose) --}}
                <div class="text-left w-full bg-rose-600 rounded-lg shadow-md card-hover p-5 animate-slide-up" style="animation-delay: 0.1s">
                    <div class="flex items-center justify-between mb-3">
                        <div class="w-11 h-11 bg-white/20 rounded-lg flex items-center justify-center">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-3xl sm:text-4xl font-bold text-white stat-num mb-1">{{ $roleCounts['admin'] }}</p>
                    <p class="text-sm text-rose-100 font-medium">Total Admin</p>
                </div>
            
                {{-- Dosen Card (Sky) --}}
                <div class="text-left w-full bg-sky-600 rounded-lg shadow-md card-hover p-5 animate-slide-up" style="animation-delay: 0.15s">
                    <div class="flex items-center justify-between mb-3">
                        <div class="w-11 h-11 bg-white/20 rounded-lg flex items-center justify-center">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-3xl sm:text-4xl font-bold text-white stat-num mb-1">{{ $roleCounts['dosen'] }}</p>
                    <p class="text-sm text-sky-100 font-medium">Total Dosen</p>
                </div>
            
                {{-- Mahasiswa Card (Emerald) --}}
                <div class="text-left w-full bg-emerald-600 rounded-lg shadow-md card-hover p-5 animate-slide-up" style="animation-delay: 0.2s">
                    <div class="flex items-center justify-between mb-3">
                        <div class="w-11 h-11 bg-white/20 rounded-lg flex items-center justify-center">
                           <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-3xl sm:text-4xl font-bold text-white stat-num mb-1">{{ $roleCounts['mahasiswa'] }}</p>
