          ...
          <tbody>
            @forelse ($penelitian as $p)
              <tr>
                ...
                <td class="text-end">
                  <a href="{{ route('dosen.penelitian.show', $p->id) }}" class="btn btn-outline-secondary btn-sm">
                    Detail
                  </a>
                  <a href="{{ route('dosen.penelitian.edit', $p->id) }}" class="btn btn-outline-primary btn-sm">
                    Edit
                  </a>
